...
insert into clients_has_spaces (receip_number, license_plate, brand, model, color, entry_date, client_id, parking_space_id)
    values ('20230313-101300', 'FIT1020', 'FIAT', 'PALIO', 'VERDE', '2023-03-13 10:15:00', 22, 100);
insert into clients_has_spaces (receip_number, license_plate, brand, model, color, entry_date, client_id, parking_space_id)
    values ('20230314-101400', 'SIE1020', 'FIAT', 'SIENA', 'BRANCO', '2023-03-14 10:15:00', 21, 200);
insert into clients_has_spaces (receip_number, license_plate, brand, model, color, entry_date, client_id, parking_space_id)
    values ('20230315-101500', 'FIT1020', 'FIAT', 'PALIO', 'VERDE', '2023-03-14 10:15:00', 22, 300);